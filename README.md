...
| **Set URL as Barcode**        | If enabled, also assigns the generated product URL as the part's barcode (via `assign_barcode`), in addition to setting the `link` field.                                                                                                                                              | `False`                     |
